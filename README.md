...
| ReplaceHeaderWhiteSpaceWith  | string       | This flag tells the reader to replace possible whitespace in the header field with specific string. Default action it to do nothing. applies only on automated headers from csv | 
